...
...
Ich habe meine database.db von Projekt 3 leicht abgeaendert.
Einzige aber durchgehende Aenderung:
ALLE Attribute die "Email" enthielten wurden zu "Email" geaendert. Dies tat ich nur aus praktischen Gruenden bei der findbyname methode im SQLiteRepository.
