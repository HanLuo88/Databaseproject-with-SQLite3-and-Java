...
public class Control
{
	...
	public Response addFahrzeug(@FormDataParam("modellid") int modellid,
	        @FormDataParam("kennzeichen") String kennzeichen, @FormDataParam("hudatum") String hudatum,
	        @FormDataParam("erstzulassung") String erstzulassung) throws SQLException
	{
		try(Connection connection = this.dataSource.getConnection())
		{
			String email = securityContext.getUserPrincipal().getName();
			String sql = "INSERT INTO Fahrzeug(ModellID, Kennzeichen, HU_datum, Erstzulassung, email) Values(?,?,?,?,?);";
	...
	// Funktioniert
	// Beispiel:
	// curl --user Kunde1@gmail.de:KUnde1 -X POST "http://localhost:8080/fahrzeuge" -H "accept: */*" -H "Content-Type:
	// multipart/form-data" -F "modellid=1" -F "kennzeichen=Kenn-Anspr-3" -F "hudatum=2011-02" -F
	// "erstzulassung=2010-01-01 12:24:59"
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	        ...
	        @QueryParam("erstzulassungsdatum") String erstzulassungsdatum) throws SQLException
	{
		...
		{
			String getFahrzeuge = "SELECT ModellID, Kennzeichen, Erstzulassung, HU_Datum " + "FROM Fahrzeug "
			        + "WHERE TRUE ";
			if(kennzeichen != null)
			{
				getFahrzeuge = getFahrzeuge + "AND Kennzeichen = '" + kennzeichen + "'";
			}
			if(erstzulassungsdatum != null)
			{
				getFahrzeuge = getFahrzeuge + "AND (julianday('" + erstzulassungsdatum
				        + "') < julianday(Erstzulassung))";
			}
	...
	// Funktioniert
	// Beispiel
	// curl --user ansprechpartner1@web.de:KLmuell3r -X GET
	// "http://localhost:8080/fahrzeuge?kennzeichen=Kenn-Anspr-1&erstzulassungsdatum=2000-01-01%2012%3A24%3A59" -H
	        ...
	        @QueryParam("bezeichnung") String bezeichnung) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			String auftragidexists = "SELECT COUNT(*) " + "FROM Auftrag " + "WHERE ? = Auftragid;";
			...
			String getErsatzteilNr = "SELECT ErsatzteilNr " + "FROM benoetigt " + "WHERE " + "? = AuftragID;";
			...
			String getErsatzteil = "SELECT * " + "FROM Ersatzteile "
			...
			if(ok)
			{
				String[] keys = new String[]{"ErsatzteilNr", "Herstellerinfo", "Ersatz_Bezeichnung", "Bild",
	...
	// Beispiel:
	// Mit Bild: curl --output - --user ansprechpartner1@web.de:KLmuell3r -X GET
	// "http://localhost:8080/auftraege/1/ersatzteile?bezeichnung=Reifen" -H "accept: application/json;charset=UTF-8"
	// Ohne Bild: curl --output - --user ansprechpartner1@web.de:KLmuell3r -X GET
	// "http://localhost:8080/auftraege/2/ersatzteile?bezeichnung=Felgen" -H "accept: application/json;charset=UTF-8"
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	        ...
	        @FormDataParam("ersatzteilid") int ersatzteilid) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			String sql = "SELECT COUNT(*) " + "FROM Auftrag " + "WHERE ? = AuftragID;";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			...
			String sql1 = "INSERT INTO benoetigt(ErsatzteilNr, AuftragID) " + "VALUES(?,?);";
	...
	// FUNKTIONIERT
	// Beispiel:
	// curl --user ansprechpartner1@web.de:KLmuell3r -X POST "http://localhost:8080/auftraege/3/ersatzteile" -H "accept:
	// */*" -H "Content-Type: multipart/form-data" -F "ersatzteilid=3"
	//////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public Response addAuftrag(@FormDataParam("fahrzeugid") int fahrzeugid,
	        @FormDataParam("beschreibung") String beschreibung, @FormDataParam("aw_anzahl") int aw_anzahl)
	        throws SQLException
	{
		long row = 0;
		try(Connection connection = dataSource.getConnection())
		{
			String sql = "SELECT Kennzeichen " + "FROM Fahrzeug " + "WHERE Fahrzeug.rowid = ?;";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			...
			String sql1 = "INSERT INTO Auftrag(AuftragID,AW_Anzahl, Beschreibung, Email, Kennzeichen)"
			        + "VALUES(?,?,?,?,?);";
			PreparedStatement preparedStatement1 = connection.prepareStatement(sql1);
	...
	// Beispiel
	// curl --user ansprechpartner1@web.de:KLmuell3r -X POST "http://localhost:8080/auftraege" -H "accept: */*" -H
	// "Content-Type: multipart/form-data" -F "fahrzeugid=1" -F "beschreibung=reifen wechseln" -F "aw_anzahl=10"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public Response getKategorie(@QueryParam("bezeichnung") String bezeichnung) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			...
			String sql = "SELECT KategorieBezeichnung " + "FROM Kategorie " + "WHERE KategorieBezeichnung = ? ";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
	...
	// Funktioniert
	// Beispiel
	// curl --user autoklar@yahoo.de:AUT0klar -X GET "http://localhost:8080/kategorien?bezeichnung=Reifen" -H "accept:
	...
	public Response addKategorie(@FormDataParam("bezeichnung") String bezeichnung) throws SQLException
	{
		try(Connection connection = dataSource.getConnection())
		{
			String sql = "INSERT INTO Kategorie(KategorieBezeichnung) " + "VALUES(?);";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			preparedStatement.setObject(1, bezeichnung);
			preparedStatement.execute();
		}
	...
	// Funktioniert
	// Beispiel:
	// curl --user autoklar@yahoo.de:AUT0klar -X POST "http://localhost:8080/kategorien" -H "accept: */*" -H
	// "Content-Type: multipart/form-data" -F "bezeichnung=Windschutzscheibe"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	        ...
	        @FormDataParam("stueckpreis") double stueckpreis) throws SQLException
	{
		...
		{
			String email = securityContext.getUserPrincipal().getName();
			String sql0 = "SELECT COUNT(*) " + "FROM Ersatzteile " + "WHERE ErsatzteilNr = ?;";
			...
			String sql = "INSERT INTO stellt_bereit(Email, ErsatzteilNr, Stueckpreis) " + "VALUES(?,?,?);";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
	...
	// Beispiel:
	// curl --user autoklar@yahoo.de:AUT0klar -X POST "http://localhost:8080/ersatzteile/4/liefert" -H "accept: */*" -H
	// "Content-Type: multipart/form-data" -F "stueckpreis=999.99"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public Response addErsatzteil(@FormDataParam("kategorieid") int kategorieid,
	        ...
	        @FormDataParam("ersatzteilnummer") int ersatzteilnummer, @FormDataParam("abbildung") String abbildung)
	        throws SQLException
	{

		try(Connection connection = dataSource.getConnection())
		{
			String sql = "SELECT KategorieBezeichnung " + "FROM Kategorie " + "WHERE Kategorie.rowid = ?;";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			...
			String sql1 = "INSERT INTO Ersatzteile(ErsatzteilNr, Herstellerinfo, Ersatz_Bezeichnung, Bild, KategorieBezeichnung) VALUES(?,?,?,?,?);";
			PreparedStatement preparedStatement1 = connection.prepareStatement(sql1);
	...
	// Beispiel:
	// curl --user autoklar@yahoo.de:AUT0klar -X POST "http://localhost:8080/ersatzteile" -H "accept: */*" -H
	// "Content-Type: multipart/form-data" -F "kategorieid=1" -F "bezeichnung=testbezeichnung1" -F
	// "herstellerinformation=bestfit" -F "ersatzteilnummer=5"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////

	@Path("modelle")
	@GET
	public Response getModell(@QueryParam("bezeichung") String bezeichnung, @QueryParam("hersteller") String hersteller,
	        @QueryParam("kw_staerke") int kw_staerke) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			...
			String sql = "SELECT * " + "FROM " + "(SELECT Modell_Bezeichnung, Hersteller, Leistung_in_KW "
			        + "FROM Modell) " + "WHERE 1=1 ";
			if(bezeichnung != null)
				sql += "AND Modell_Bezeichnung LIKE \'%" + bezeichnung + "%\'";
			if(hersteller != null)
				sql += "AND Hersteller LIKE \'%" + hersteller + "%\'";
			if(kw_staerke > 0)
				sql += "AND Leistung_in_KW LIKE \'%" + kw_staerke + "%\'";
			PreparedStatement preparedStatement = connection.prepareStatement(sql);
			ok = preparedStatement.execute() && ok;
			...
			if(ok)
			{
				String[] keys = new String[]{"ModellID", "Hersteller", "Modell_Bezeichnung", "Leistung_in_KW", "Typ",
				        "Klasse"};
	...
	// Funktioniert
	// Beispiel:
	// curl -X GET "http://localhost:8080/modelle?bezeichnung=3er&hersteller=BMW&kw_staerke=215" -H "accept:
	// application/json;charset=UTF-8"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	public Response getAdressen(@QueryParam("plz") String plz) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			String plzexists = "SELECT COUNT(*) " + "FROM Adresse " + "WHERE PLZ = ?;";
			...
			String adressen = "SELECT PLZ, Stadt, Strasse, Hausnummer " + "FROM Adresse " + "WHERE PLZ = ?;";
	        ...
	        @QueryParam("ersatzteilnummer") int ersatzteilnummer) throws SQLException
	{
		...
		try(Connection connection = this.dataSource.getConnection())
		{
			String getErsatzteileAllUser = "SELECT Ersatz_Bezeichnung, ErsatzteilNr " + "FROM Ersatzteile "
			        + "WHERE ? = Ersatz_Bezeichnung " + "AND" + "? = ErsatzteilNr;";
			PreparedStatement preparedStatementAllUserGetErsatzteile = connection
			        .prepareStatement(getErsatzteileAllUser);
	...
	// Funktioniert
	// Beispiel:
	// curl -X GET "http://localhost:8080/ersatzteile?bezeichnung=DunlopWinterreifen%202000X%20TURBO&ersatzteilnummer=1"
	// -H "accept: application/json;charset=UTF-8"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////

	@Path("werkstaetten")
	@GET
	public Response getWerkstaetten(@QueryParam("name") String name, @QueryParam("stadt") String stadt,
	        @QueryParam("preis") double preis) throws SQLException
	{
		boolean ok = true;
		try(Connection connection = this.dataSource.getConnection())
		{
			String getWerkstattID = "SELECT WerkstattID FROM ansaessig_bei WHERE ansaessig_bei.AdressID = (SELECT AdressID FROM Adresse WHERE  Stadt = ?);";
			...
			String getWerkstaette = "SELECT * FROM Werkstatt WHERE WerkstattID = ? AND Preis_pro_AW <= ? AND WerkstattName = ?;";
	...
	// Funktioniert
	// Beispiel:
	// curl -X GET "http://localhost:8080/werkstaetten?name=CarGawd&stadt=Koeln&preis=20.0" -H "accept:
	// application/json;charset=UTF-8"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////

	@Path("ansprechpartner")
	@POST
	public Response addAnsprechpartner(@FormDataParam("adresseid") int adresseid, @FormDataParam("email") String email,
	        @FormDataParam("passwort") String passwort, @FormDataParam("vorname") String vorname,
	        @FormDataParam("nachname") String nachname, @FormDataParam("mitarbeiternummer") String mitarbeiternummer,
	        @FormDataParam("name") String name, @FormDataParam("preis_je_aw") double preis_je_aw) throws SQLException
	{
		...
		try(Connection connection = dataSource.getConnection())
		{
			...
			String getWerkstattID = "SELECT WerkstattID " + "FROM ansaessig_bei " + "WHERE AdressID = ?;";
			...
			String sql1 = "INSERT INTO Werkstatt(WerkstattID, Preis_pro_AW, Werkstattname) " + "VALUES(?,?,?);";
			PreparedStatement preparedStatement1 = connection.prepareStatement(sql1);
			preparedStatement1.setObject(1, werkstattid);
			preparedStatement1.setObject(2, preis_je_aw);
			preparedStatement1.setObject(3, name);

			String sql2 = "INSERT INTO Ansprechpartner(Email, MA_Nr, WerkstattID) " + "VALUES(?,?,?);";
	...
	// Funktioniert
	// Beispiel:
	// curl -X POST "http://localhost:8080/ansprechpartner" -H "accept: */*" -H "Content-Type: multipart/form-data" -F
	// "email=ansprtester@an.de" -F "passwort=AnSprecht3st" -F "vorname=Ansprech" -F "nachname=Testeins" -F
	// "mitarbeiternummer=3" -F "name=CarGawd" -F "preis_je_aw=15.10" -F "adresseid=1"
	/////////////////////////////////////////////////////////////////////////////////////////////////////////

	@Path("lieferanten")
	@POST
	public Response addLieferant(@FormDataParam("email") String email, @FormDataParam("passwort") String passwort,
	        @FormDataParam("vorname") String vorname, @FormDataParam("nachname") String nachname,
	        @FormDataParam("name") String name) throws SQLException
	{
		...
		try(Connection connection = dataSource.getConnection())
		{
			...
			String sql1 = "INSERT INTO Lieferant(Email, Haendlername)" + "VALUES(?,?);";
			PreparedStatement preparedStatement1 = connection.prepareStatement(sql1);
	...
	// Funktioniert
	// curl -X POST "http://localhost:8080/lieferanten" -H "accept: */*" -H "Content-Type: multipart/form-data" -F
	// "email=liefertester1@lief.de" -F "passwort=LieFer1" -F "vorname=Liefer" -F "nachname=Ranteins" -F "name=Super
	// Mechanic"
	//////////////////////////////////////////////////////////////////////////////////////////////////////////

	@Path("kunden")
	@POST
	public Response addKunde(@FormDataParam("adressid") int adressid, @FormDataParam("email") String email,
	        @FormDataParam("passwort") String passwort, @FormDataParam("vorname") String vorname,
	        @FormDataParam("nachname") String nachname, @FormDataParam("werbeeinwilligung") boolean werbeeinwilligung,
	        @FormDataParam("telefonnummer") String telefonnummer) throws SQLException
	{
		...
		try(Connection connection = dataSource.getConnection())
		{
			...
			String sql1 = "INSERT INTO Kunde(Email, Rueckrufnummer, Werbeeinwilligung, AdressID)" + "VALUES(?,?,?,?);";
			PreparedStatement preparedStatement1 = connection.prepareStatement(sql1);
			preparedStatement1.setObject(1, email);
	...
	// Funktioniert
	// Beispiel
	// curl -X POST "http://localhost:8080/kunden" -H "accept: */*" -H "Content-Type: multipart/form-data" -F
	// "adresseid=1" -F "email=kundetester1@kun.de" -F "passwort=KUndet1" -F "vorname=Kund" -F "nachname=etesteins" -F
	// "werbeeinwilligung=false" -F "telefonnummer=164589"
